...
#pragma omp critical
		...
		if (name == "U3M")
		{
			...
			if (found)
			{
				...
				double new_rmse = RMSE_calculate(cloud_src, best_est, GTmat);
				evaluation_est(best_est, GTmat, RE_thresh, TE_thresh, new_re, new_te);
				if (new_re < RE && new_te < TE)
				{
					cout << "est_trans updated!!!" << endl;
					cout << "RE=" << new_re << " " << "TE=" << new_te << " RMSE= " << new_rmse << "   1" << endl;
					cout << best_est << endl;
				}
				else {
					best_est = tmp_best;
					cout << "RE=" << RE << " " << "TE=" << TE << " RMSE= " << new_rmse << "   2" << endl;
					cout << best_est << endl;
				}
				RE = new_re;
				TE = new_te;
				...
				if (found)
				{
					...
					cout << "RE=" << RE << " " << "TE=" << TE << " " << "RMSE= " << new_rmse << "   3" << endl;
					cout << best_est << endl;
					return true;
				}
				...
				cout << "RE=" << RE << " " << "TE=" << TE << " " << "RMSE= " << new_rmse << "   4" << endl;
				return false;
			}
	}
